"use strict";(self.webpackChunklevel_game=self.webpackChunklevel_game||[]).push([[796],{1796:(e,r,n)=>{n.r(r),n.d(r,{default:()=>l});n(5043),n(7258);var t=n(8628),i=n(6218),s=(n(6050),n(5348),n(8819)),a=(n(1908),n(579));const l=()=>(0,a.jsx)(s.Gy,{children:(0,a.jsx)(s.ee,{children:(0,a.jsxs)(t.A.Body,{children:[(0,a.jsx)(t.A.Title,{children:"The levels become more sparse"}),(0,a.jsx)(t.A.Text,{children:"But it's only to avoid having too much fluff! Why don't you see what else you can do with the levels you've already discovered?"}),(0,a.jsx)(s.W0,{children:(0,a.jsx)(i.A,{targetLevel:150})})]})})})},1908:(e,r,n)=>{n.d(r,{A:()=>h});n(5043);var t=n(5464),i=n(3003),s=n(8628),a=n(6481),l=(n(6218),n(579));const o=t.Ay.div`
  width: 100%;
  margin: 2rem auto;
  text-align: center;
`,d=(0,t.Ay)(s.A)`
...
//# sourceMappingURL=796.f1eccdb9.chunk.js.map