"use strict";(self.webpackChunklevel_game=self.webpackChunklevel_game||[]).push([[5549],{5549:(e,r,t)=>{t.r(r),t.d(r,{default:()=>k});var a=t(5043),o=t(8628),i=t(8819),d=t(9642),n=t(5464),l=t(3003),s=t(614);const m={INTEGERS:"Integers",REALS:"Reals",COMPLEX:"Complex",BEYOND:"Beyond"},c=e=>{const r=(0,s.RP)(e);if("object"!==typeof r||!("real"in r))return null;return`hsl(${(Math.atan2(r.imag,r.real)+Math.PI)/(2*Math.PI)*360}, 70%, 50%)`};var h=t(579);const g=n.Ay.div`
...
//# sourceMappingURL=5549.96970746.chunk.js.map