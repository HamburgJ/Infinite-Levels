"use strict";(self.webpackChunklevel_game=self.webpackChunklevel_game||[]).push([[6e3],{5473:(e,t,i)=>{i.d(t,{D7:()=>g,HD:()=>o,Kz:()=>s,bP:()=>d});var n=i(5464);n.i7`
  0% {
...
`,g=n.Ay.div`
  ...
  margin: 1rem 0;
  max-width: 600px;
`},6e3:(e,t,i)=>{i.r(t),i.d(t,{default:()=>l});i(5043);var n=i(6218),r=i(5473),a=i(579);const l=()=>(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(r.Kz,{complexAngle:.25}),(0,a.jsxs)(r.HD,{children:[(0,a.jsx)(r.bP,{rotated:!0,children:"\u221ei"}),(0,a.jsx)(r.D7,{children:"You've reached imaginary infinity. Reality bends perpendicular to itself."}),(0,a.jsx)(r.D7,{children:"In this realm, all divergances converge back to one, infinity loops back to itself, plus I think it really big."}),(0,a.jsx)("div",{className:"d-flex justify-content-center",children:(0,a.jsx)(n.A,{targetLevel:0,variant:"outline-light",children:"Return to Reality"})})]})]})}}]);
//# sourceMappingURL=6000.f528087c.chunk.js.map