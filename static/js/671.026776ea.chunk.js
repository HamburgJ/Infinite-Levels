"use strict";(self.webpackChunklevel_game=self.webpackChunklevel_game||[]).push([[671],{5473:(e,n,t)=>{t.d(n,{D7:()=>f,HD:()=>g,Kz:()=>d,bP:()=>c});var i=t(5464);const r=i.i7`
  0% {
...
`,d=i.Ay.div`
  ...
  &::before {
    ...
    animation: ${e=>e.complexCombination?i.AH`${r} 20s linear infinite,
         ...
         ${s} 15s ease-in-out infinite`:i.AH`${r} 20s linear infinite,
         ${l} 8s ease-in-out infinite`};
...
`,f=i.Ay.div`
  ...
  margin: 1rem 0;
  max-width: 600px;
`},3671:(e,n,t)=>{t.r(n),t.d(n,{default:()=>l});t(5043);var i=t(6218),r=t(5473),a=t(579);const l=()=>(0,a.jsxs)(a.Fragment,{children:[(0,a.jsx)(r.Kz,{}),(0,a.jsxs)(r.HD,{children:[(0,a.jsx)(r.bP,{children:"\u221e"}),(0,a.jsx)(r.D7,{children:"You've reached the infinite level. Here, all paths converge and diverge eternally."}),(0,a.jsx)(r.D7,{children:"The boundary between numbers dissolves, and reality becomes fluid."}),(0,a.jsx)("div",{className:"d-flex justify-content-center",children:(0,a.jsx)(i.A,{targetLevel:0,variant:"outline-light",children:"Return to Reality"})})]})]})}}]);
//# sourceMappingURL=671.026776ea.chunk.js.map