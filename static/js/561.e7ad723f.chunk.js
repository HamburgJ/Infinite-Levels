"use strict";(self.webpackChunklevel_game=self.webpackChunklevel_game||[]).push([[561],{5473:(e,t,n)=>{n.d(t,{D7:()=>f,HD:()=>g,Kz:()=>d,bP:()=>c});var i=n(5464);const a=i.i7`
  0% {
...
`,d=i.Ay.div`
  ...
  &::before {
    ...
    animation: ${e=>e.complexCombination?i.AH`${a} 20s linear infinite,
         ...
         ${o} 15s ease-in-out infinite`:i.AH`${a} 20s linear infinite,
         ${l} 8s ease-in-out infinite`};
  ...
  &::after {
    ...
    animation: ${s} 10s ease-in-out infinite;
    mix-blend-mode: screen;
  }
`,g=i.Ay.div`
  position: fixed;
...
`,f=i.Ay.div`
  ...
  margin: 1rem 0;
  max-width: 600px;
`},8561:(e,t,n)=>{n.r(t),n.d(t,{default:()=>l});n(5043);var i=n(6218),a=n(5473),r=n(579);const l=()=>(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(a.Kz,{complexAngle:270}),(0,r.jsxs)(a.HD,{children:[(0,r.jsx)(a.bP,{isNegative:!0,rotated:!0,children:"-\u221ei"}),(0,r.jsx)(a.D7,{isNegative:!0,children:"You've reached negative imaginary infinity. Reality inverts and bends simultaneously."}),(0,r.jsx)(a.D7,{isNegative:!0,children:"The complex plane folds back on itself, creating impossible geometries."}),(0,r.jsx)("div",{className:"d-flex justify-content-center",children:(0,r.jsx)(i.A,{targetLevel:0,variant:"outline-dark",children:"Return to Reality"})})]})]})}}]);
//# sourceMappingURL=561.e7ad723f.chunk.js.map