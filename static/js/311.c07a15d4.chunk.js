...
`,O=e=>{let{data:t,depth:n=0,path:i=""}=e;return Array.isArray(t)?0===t.length?(0,x.jsx)(K,{children:(0,x.jsx)(S.A,{text:"Keep searching..."})}):"string"===typeof t[0]||r.isValidElement(t[0])?(0,x.jsx)(K,{children:"string"===typeof t[0]?(0,x.jsx)(S.A,{text:t.join(" ")}):t[0]}):(0,x.jsx)(M,{alwaysOpen:!0,children:t.map(((e,t)=>{const r=`${i}-${t}`;return(0,x.jsxs)(E.Item,{eventKey:r,children:[(0,x.jsx)(E.Header,{}),(0,x.jsx)(E.Body,{children:(0,x.jsx)(O,{data:e,depth:n+1,path:r})})]},r)}))}):null},T=O}}]);
//# sourceMappingURL=311.c07a15d4.chunk.js.map