...
`,T=e=>{let{data:t,openSections:n=[],visitedSections:a=[],onToggle:o,depth:s=0,path:i=""}=e;return Array.isArray(t)?0===t.length?(0,x.jsx)(K,{children:(0,x.jsx)(S.A,{text:"Keep searching..."})}):"string"===typeof t[0]||r.isValidElement(t[0])?(0,x.jsx)(K,{children:"string"===typeof t[0]?(0,x.jsx)(S.A,{text:t.join(" ")}):t[0]}):(0,x.jsx)(B,{activeKey:n.filter((e=>e.startsWith(i))),alwaysOpen:!0,children:t.map(((e,t)=>{const r=i?`${i}-${t}`:`${t}`,c=a.includes(r);return(0,x.jsxs)(E.Item,{eventKey:r,className:c?"visited":"",children:[(0,x.jsx)(E.Header,{onClick:()=>o(r)}),(0,x.jsx)(E.Body,{children:(0,x.jsx)(T,{data:e,openSections:n,visitedSections:a,onToggle:o,depth:s+1,path:r})})]},r)}))}):null},I=T}}]);
//# sourceMappingURL=7570.76c09bc3.chunk.js.map