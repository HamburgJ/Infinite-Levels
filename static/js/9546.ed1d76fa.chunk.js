"use strict";(self.webpackChunklevel_game=self.webpackChunklevel_game||[]).push([[9546],{4697:(e,t,n)=>{n.d(t,{A:()=>p});var r=n(5043),i=n(5464),a=n(3003),o=n(8565),s=n(3888),l=n(4282),d=n(579);const c=i.Ay.div`
  display: flex;
  align-items: center;
  gap: 1.5rem;
...
`,le=i.Ay.div`
  ...
  box-shadow: inset 0 2px 4px rgba(0, 0, 0, 0.2);
`,de=()=>{const e=(0,s.wA)(),t=(0,s.d4)((e=>e.inventory.equippedItem)),n=(0,s.d4)((e=>e.inventory.bookshelf)),[i,a]=(0,r.useState)(!1),[o,l]=(0,r.useState)(null);return(0,p.jsx)(ae,{children:[0,1,2].map((r=>(0,p.jsx)(oe,{children:[0,1,2].map((i=>{const a=3*r+i;return(0,p.jsx)(se,{onClick:r=>((r,i)=>{"contextmenu"===(null===i||void 0===i?void 0:i.type)&&i.preventDefault();const a=n[r];t&&!a&&(e((0,re.mO)({item:t,index:r})),e((0,re.lS)()))})(a,r),canInteract:!n[a],children:n[a]?(0,p.jsx)(ie.A,{item:n[a],isStorage:!0,forceAvailable:!0}):(0,p.jsx)(le,{children:"Empty"})},i)}))},r)))})};var ce=n(7088),he=n(2993);const me=(0,i.Ay)(a.A)`
  display: flex;
  flex-direction: column;
  align-items: center;
  width: 100%;
...
//# sourceMappingURL=9546.ed1d76fa.chunk.js.map